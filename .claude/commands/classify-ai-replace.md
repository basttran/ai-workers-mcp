---
description: Classifie le texte dans une catégorie avec l'IA — remplace la sélection.
argument-hint: [catégories]
---

Invoque `mcp__ai-workers__ai_classify` sur la sélection IDE, puis remplace-la.
