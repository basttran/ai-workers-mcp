---
description: Corrige le texte avec l'IA — insère le résultat après la sélection.
argument-hint: [texte source]
---

Invoque `mcp__ai-workers__ai_proofread` sur la sélection IDE, puis insère après.
